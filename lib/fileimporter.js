  ...
  FileImporter = (function() {
    ...
    */
    ...
    FileImporter.prototype._getExportFilesHTML = function(files, type, merge) {
      ...
      mergeFile = function(files) {
        ...
        linkFileName = fileMerger.mergeFilesToTemp(files, type, _this.options.path, _this.options.mergePath);
      ...
      if (this.options.exportType === 'array' && type === 'js') {
    ...
    */
    ...
    FileImporter.prototype._exportJsHTML = function(file) {
      ...
      if (this.options.exportType === 'array') {
        return url;
      } else {
