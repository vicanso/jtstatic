  ...
  FileImporter = (function() {
    ...
    */
    ...
    FileImporter.prototype.exportCss = function(merge) {
      return this._getExportFilesHTML(this.cssFiles, 'css', merge, this.hosts);
    };
    ...
    */
    ...
    FileImporter.prototype.exportJs = function(merge) {
      return this._getExportFilesHTML(this.jsFiles, 'js', merge, this.hosts);
    };
    ...
    */
    ...
    FileImporter.prototype._getExportFilesHTML = function(files, type, merge, hosts) {
